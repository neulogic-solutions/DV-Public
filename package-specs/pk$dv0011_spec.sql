create or replace PACKAGE pk$dv0011 AUTHID DEFINER AS
 /**
  * ===========================================================<br/>
  *  PURPOSE : DV Setup - Currencies <br/>
  ...
  */
  ...
  --
  --
  PROCEDURE pr_prc (pi_rec IN OUT dv_vt_00_curr_e%ROWTYPE);
  --
  --
  FUNCTION fn_dtl (pi_key IN NUMBER) RETURN dv_vt_00_curr%ROWTYPE;
  --  
  --
  FUNCTION fn_dtl_e (pi_key IN NUMBER) RETURN dv_vt_00_curr_e%ROWTYPE;
  --  
  --

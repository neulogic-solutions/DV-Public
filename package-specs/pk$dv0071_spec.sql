create or replace PACKAGE pk$dv0071 AUTHID DEFINER AS
 /**
  * ===========================================================<br/>
  ...
  */
  ...
  PROCEDURE pr_prc (pi_rec IN OUT dv_vt_20_sec_e%ROWTYPE);
  --
  
  FUNCTION fn_dtl (pi_key IN NUMBER) RETURN dv_vt_20_sec%ROWTYPE;
  --
  
  FUNCTION fn_dtl_e (pi_key IN NUMBER) RETURN dv_vt_20_sec_e%ROWTYPE;
  --  
 ...
 FUNCTION fn_ast_key (pi_key IN NUMBER) RETURN NUMBER;

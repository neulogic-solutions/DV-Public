create or replace PACKAGE BODY pk$dv0029 AS
 /**
  * ===========================================================<br/>
  ...
  */
  ...
  --
    BEGIN 
		RETURN pkdv_10_bkr_xpv.fn_edt; 
    END fn_edt;
  --
  PROCEDURE pr_mnt (pi_key NUMBER) IS 
    BEGIN 
		pkdv_10_bkr_xpv.pr_mnt (pi_key => pi_key); 
		pkdv_00.pr_commit; 
	END pr_mnt;
  --
  PROCEDURE pr_mnt_all IS 
    BEGIN 
		pkdv_10_bkr_xpv.pr_mnt_all; 
		pkdv_00.pr_commit; 
	END pr_mnt_all;
  --
  PROCEDURE pr_prc (pi_rec IN dv_vt_00_xpv_e%ROWTYPE) IS 
    BEGIN 
		pkdv_10_bkr_xpv.pr_prc (pi_rec => pi_rec); 
		pkdv_00.pr_commit; 
	END pr_prc;
	--
  --
